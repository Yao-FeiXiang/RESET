...
file_path = "../../graph_datasets/sss_figure.txt"
...
ax.set_title('SSS - Speedup', fontsize=16, pad=15, color='#2c3e50', weight='bold')
...
ax.set_title('SSS - Coalescing Comparison', fontsize=16, pad=15, color='#2c3e50', weight='bold')
...
plt.savefig('../../../figure/sss_summary_all.pdf', dpi=300, bbox_inches='tight')
print("Generated sss_summary_all.pdf")
plt.close()