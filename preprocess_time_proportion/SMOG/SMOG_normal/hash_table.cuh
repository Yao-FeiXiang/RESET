...
tuple<long long *, int *, long long, double> buildHashTable(int *d_adjcant, int *d_vertex, int *d_degree_offset, int *d_dispersed_mapping);
...
__inline__ __device__ bool search_in_hashtable(int x, int bucket_size, long long bucket_num, int hash_table_len, int *hash_table,int* dispersed_mapping)
{
